...
/*
    Erros do estagiário:
         - utilizar duas diretivas de compilação pararelas uma fora e outra dentro do loop, o que pode
        levar a sobrecarrga ou sincrinização desnecessária.

        - as varíaveis i, j não estão como privadas e estão sendo usadas dentro das diretivas, o que
        pode levar a condições de corrida, gerando resultados incorretos.
*/
