...
/*
    Calculando o speedUp:
        rodando o programa com apenas uma thread, tivemos um tempo de 0.941 segundos
        rodando o programa com 5 threads, tivemos um tempo de  0.215 segundos

        ou seja 0.941/0.215 = 4.37

        o SpeedUp foi de aproximadamente 4.37
*/
